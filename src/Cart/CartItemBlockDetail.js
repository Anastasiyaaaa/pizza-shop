...
export default function CartItemBlockDetails(props) {
    const { details, id, idCategory, idDetails, idTypeSize, q } = props.pizza;
    ...
    console.log(details, id, idCategory, idDetails, idTypeSize, q)
    // console.log("full")
    return (
